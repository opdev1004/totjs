...
export async function getAllByDict(filename, encoding = 'utf8', streamCount = DefaultStreamCount)
{
    try
    {
        ...
        const result = await processGetAllByDict(filename, encoding, streamCount);
        return result;
    } catch (error)
    {
...
async function processGetAllByDict(filename, encoding = 'utf8', streamCount = DefaultStreamCount)
{
