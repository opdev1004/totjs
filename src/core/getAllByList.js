...
export async function getAllByList(filename, encoding = 'utf8', streamCount = DefaultStreamCount)
{
    try
    {
        ...
        const result = await processGetAllByList(filename, encoding, streamCount);
        return result;
    }
    catch (error)
    {
...
async function processGetAllByList(filename, encoding, streamCount)
{
